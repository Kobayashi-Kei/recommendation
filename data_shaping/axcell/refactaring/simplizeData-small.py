...
outputDir = "data/newAxcell/small/"
originalDirName = "mini"

"""
論文のメタデータとアブストを分離してファイル出力
"""
path = "data/axcell/" + originalDirName + "/axcellRecomData-old-includeLabeled.json"
...
"""    
path = "data/axcell/" + originalDirName +  "/axcellRecomData-old-includeEmb-includeLabelEmb.json"
with open(path , 'r') as f:
    data = json.load(f)
