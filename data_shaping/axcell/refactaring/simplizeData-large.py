...
outputDir = "data/newAxcell/large/"
originalDirName = ""

"""
論文のメタデータとアブストを分離してファイル出力
"""
path = "data/axcell" + originalDirName + "/axcellRecomData-includeLabeled.json"
...
"""    
path = "data/axcell" + originalDirName +  "/axcellRecomData-includeEmb-includeLabelEmb.json"
with open(path , 'r') as f:
    data = json.load(f)
