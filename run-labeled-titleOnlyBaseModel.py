...
・SPECTERの追加学習済みモデルを指定してもtitleのみ追加学習無しモデルを用いる。
"""	
def main():
    ...
    for title in labeledAbstDict:
        ...
        # labeledAbstDict[title]["bg"] = labeledAbstDictForTitle[title]["bg"]
        # labeledAbstDict[title]["method"] = labeledAbstDictForTitle[title]["method"]
        # labeledAbstDict[title]["res"] = labeledAbstDictForTitle[title]["res"]
    """
    データの整形
    """
